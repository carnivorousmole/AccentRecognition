...
from build_model import extract_features, derive_hilbert_s, derive_mel_s

img_path = "test_images"
audio_file = "/Users/dylanwalsh/Code/input/audio_files/testing/Siren.wav"
audio_file = "/Users/dylanwalsh/Code/input/audio_files/audios_word_split_regrouped/and_please_call_Stella_/arabic/arabic141.wav"
...
def main():
    ...
    features = extract_features(audio_file,"fbe_hil")
    # features = derive_hilbert_s(audio_file, y )
    # plot as image
